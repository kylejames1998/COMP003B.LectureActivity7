...
namespace COMP003B.LectureActivity7.Controllers
{
    ...
    {
        private readonly ProgrammingAcademyContext _context;

        public EnrollmentsController(ProgrammingAcademyContext context)
        {
            _context = context;
        }
        ...
        {
            var programmingAcademyContext = _context.Enrollments.Include(e => e.Course).Include(e => e.Student);
            return View(await programmingAcademyContext.ToListAsync());
        }
